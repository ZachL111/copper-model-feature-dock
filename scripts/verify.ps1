...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-copper-model-feature-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-copper-model-feature-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-copper-model-feature-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-copper_model_feature_dock-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
