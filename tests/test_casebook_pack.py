"""Regression checks for the copper-model-feature-dock casebook."""
...
from casebook.harness import assert_expected, copper_model_feature_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_model_feature_dock_summary(), assert_expected())
